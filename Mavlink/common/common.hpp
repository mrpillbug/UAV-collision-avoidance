...
enum class MAV_CMD : uint16_t
{
    ...
    STORAGE_FORMAT=526, /* WIP: Format a storage medium |Storage ID| 0: No action 1: Format storage| Reserved (all remaining params)|  */
    REQUEST_CAMERA_CAPTURE_STATUS=527, /* WIP: Request camera capture status (CAMERA_CAPTURE_STATUS) |Camera ID| 0: No Action 1: Request camera capture status| Reserved (all remaining params)|  */
